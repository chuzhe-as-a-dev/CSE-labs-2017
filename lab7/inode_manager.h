...
private:
    ...
    bool vote(bool bit0, bool bit1, bool bit2);

public:
    abstract_byte(char data);
    abstract_byte(char coded0, char coded1, char coded2, char coded3);

    char actual, coded0, coded1, coded2, coded3;
    bool corrupted;
};
